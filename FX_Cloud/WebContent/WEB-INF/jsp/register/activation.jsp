...
<body class="body">
<sf:form name="registrationPost" method="post">
  ...
  <tr>
    ...
    <td colspan="3" rowspan="2"  class="re_noticeTd1">
        <table width="540" height="360" border="0" cellpadding="0" cellspacing="0" class="re_word">
          ...
          <tr>
            <td width="33">&nbsp;</td>
            <td width="137">请输入激活码：</td>
            <td width="19">&nbsp;</td>
            <td colspan="2"><input type="text" name="activate"  />${error}<span  id="show" ></span></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td colspan="2"><input type="submit" name="button" id="button" value="提交"  class="re_button"/></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
