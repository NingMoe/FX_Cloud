...
<body>
<sf:form method="post" modelAttribute="user">	<!-- 提交给自己不用写action，控制器绑定的对象叫User,所以modelAttribute就算user -->
<table width="700" align="center" border="1">
	<tr>
	<td>用户:</td><td><sf:input path="username"/><sf:errors path="username"/></td>
	</tr>
	<tr>
